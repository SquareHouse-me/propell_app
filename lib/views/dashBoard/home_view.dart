  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child:
            isMobile
                ? AppbarWidget(title: '', isFirstPage: true)
                : WebAppbarWidget(),
      ),
      body: Obx(
        () =>
            homeC.cateogryStatus.value == Status.LOADING
                          ...
                          child: Padding(
                            ...
                            child: ResponsiveRowColumn(
                              ...
                              children: [
                                ...
                                ResponsiveRowColumnItem(child: 20.heightSpace),
                                ResponsiveRowColumnItem(
                                  child: SizedBox(
                                      ...
                                      children:
                                          homeC.categoryList.value.map((item) {
                                            return buildOptionCard(
                                              ...
                                              context,
                                              icon:
                                                  item.image, // Use the appropriate field for the icon
                                              label:
                                                  item.name.split(
                                                    ' ',
